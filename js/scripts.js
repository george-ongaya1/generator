    ...
    if (myGenderValue == "male" && monthValid && dayValid){
      switch (dayOfWeekNumber) {
        case 1:
          ...
          document.getElementById('display-name').textContent = "Provided is your Akan name brother: ";
          return false;
          break;
        case 2:
      ...
      switch (dayOfWeekNumber) {
        case 1:
          ...
          document.getElementById('display-name').textContent = "Provided is your Akan name sister: ";
          return false;
          break;
        case 2:
